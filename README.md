...
<p align="center">
  <img src="figs/meta-archi3.png" width="500">
</p>
...
Using `(\phi - \phi')` as gradient we can use an optimizer to update the meta weights instead of manually modifying the weights (as per the paper):
